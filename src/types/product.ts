...
export const productSchema = z.object({
  ...
  brand: z.string().or(z.object({})).optional(),
  model: z.string().or(z.object({})).optional(),
  year: z.string().or(z.object({})).optional(),
  color: z.string().or(z.object({})).optional(),
  size: z.string().or(z.object({})).optional(),
  ...
  handling_time: z.string().or(z.object({})).optional(),
